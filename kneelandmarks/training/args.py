...
def parse_args():
    ...
    parser.add_argument('--fast_hg', type=bool, default=False)
    ...
    parser.add_argument('--hg_refine', type=bool, default=False)
    parser.add_argument('--heatmap_pad', type=int, default=10, help='heatmap-based 2d argmax')
